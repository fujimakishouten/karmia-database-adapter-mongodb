...
/**
 * KarmiaDatabaseAdapterMongoDBTableSuite
 *
 * @class
 */
class KarmiaDatabaseAdapterMongoDBTableSuite {
    /**
     * Constructor
     *
     ...
     * @constructs KarmiaDatabaseAdapterMongoDBTableSuiteSuite
     */
...
module.exports = function (adapter, name, tables, id) {
    return new KarmiaDatabaseAdapterMongoDBTableSuite(adapter, name, tables, id);
};
