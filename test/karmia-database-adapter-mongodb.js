...
const expect = require('expect.js'),
    ...
    options = {
        host: 'localhost',
        port: 27017,
        database: 'karmia_database_adapter_mongodb'
    };


// Test
describe('karmia-database-adapter-mongodb', function () {
        ...
        describe('Should sync database', function () {
            it('Promise', function (done) {
                ...
                database.define(key, schema).sync().then(function () {
                    expect(database.tables[key].constructor.name).to.be('KarmiaDatabaseAdapterMongoDBTable');
    ...
    describe('table', function () {
        ...
        it('Should get table', function (done) {
            const table = database.table(key);
            expect(table.constructor.name).to.be('KarmiaDatabaseAdapterMongoDBTable');
                ...
                it('Promise', function (done) {
                    ...
                    table.get({user_id: data.user_id}).then(function (result) {
                        ...
                        return new Promise(function (resolve, reject) {
                            return table.model.remove({user_id: data.user_id}, function (error, result) {
    ...
    describe('sequence', function() {
        ...
        it('Should get sequence', function (done) {
            ...
            expect(sequence.constructor.name).to.be('KarmiaDatabaseAdapterMongoDBSequence');
    ...
    describe('suite', function () {
        ...
        it('Should create table suite', function (done) {
            ...
            expect(suite.constructor.name).to.be('KarmiaDatabaseAdapterMongoDBTableSuite');
